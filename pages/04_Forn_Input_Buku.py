...
st.set_page_config(page_title="Library Book Input Form", page_icon="📚", layout="centered")
...
def create_data(judul, pengarang, image, penerbit, tahun_terbit, kategori, stok):
    ...
    val = (judul, pengarang, image_name, penerbit, tahun_terbit, kategori, stok)
...
image = form.file_uploader("Upload Book Cover Image", type=["jpg", "jpeg", "png"])
...
if submitted:
    create_data(judul, pengarang, image, penerbit, tahun_terbit, kategori, stok)
    st.snow()
